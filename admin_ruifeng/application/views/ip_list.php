				...
				<div class="col-lg-4 col-md-8">
					<div class="input-group">
						...
						<span class="input-group-btn">
							<a class="btn btn-danger" onclick="ip_save()"><i class="fa fa-fw fa-ban"></i>屏蔽该IP</a>
						</span>
					</div>
				</div>
				<form>
			...
			<div class="panel-body">
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							<?php foreach($ip_list as $k => $v):
								$k = str_replace('ipban_', '', $k);
							?>
							<tr>
								<td><?php echo $k; ?></td>
								<td><?php echo $v; ?></td>
...
function ip_del(obj, forbidden){
	$.post(admin.url+'ip/ip_del/',{forbidden:forbidden},function (){
...
function ip_save(){
    ...
    $.post(admin.url+'ip/ip_ban',{forbidden:forbidden},function (result){
