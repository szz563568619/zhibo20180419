		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="table-responsive">
					<iframe src="groupchat/im_page" frameborder="0" style="width:100%;height:600px;min-height:534px;min-width:802px;overflow:hidden;"></iframe>
				</div>
			</div>
		</div>
	</div>
...
function open_chat_record(id, gid){
	$('#chat_record iframe').attr('src', 'groupchat/minichat_list/'+id+'/'+gid);
